...
/**Slice for user registering, logging in, getting current user, updating user, and password */
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(updateUser.rejected, (state, { payload }) => {
                state.error = payload
                state.message = 'Update was not successful! Check the password or the provided user information.'
                state.loading = false
            })
