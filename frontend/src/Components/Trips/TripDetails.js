...
import { Stack, Grid, Container, List, ListItemButton, ListItemText, Typography, Button } from '@mui/material';
...
const TripDetails = () => {
    ...
    useEffect(() => {
        ...
        }, [dispatch, success_tripDetails,  tripId])
